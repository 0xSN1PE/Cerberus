...
async def on_message(message):
	...
	for word in words:
		if message.content.find(word) != -1:
			embed = discord.Embed(title="Read the Rules!", description="You're asking something that violates the rules of this server please read the rules before asking something again. If you continue doing this you will be banned from this server permanently!")
